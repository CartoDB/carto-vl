...
**Note:**
If styling isn't tied directly to a styling property, you will need to use a [variable](https://carto.com/help/glossary/#variable). We will explore that method in detail in the [Add Widgets](/developers/carto-vl/guides/add-widgets/) guide.
