 ...
 *   symbol: s.ramp(s.buckets(s.prop('pop_max'), [10]), s.sprites([s.image('./marker.svg'), s.image('./marker2.svg')]))
 * });
 *
 * @example <caption>Match different sprites to the different categories generated by buckets. (String)</caption>
 * const viz = new carto.Viz(`
 *    symbol: ramp(buckets($pop_max, [10]), sprites([image('./marker.svg'), image('./marker2.svg')]))
 * `);
 *
