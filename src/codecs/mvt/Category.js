...
export default class MVTCategoryCodec extends CategoryCodec {
    sourceToInternal (metadata, propertyValue, propertyName) {
        ...
        if (propertyValue !== null && propertyValueType !== 'undefined' && propertyValueType !== 'string') {
            ...
            throw new CartoRuntimeError(`${crt.MVT} MVT decoding error. Metadata property '${propertyName}' is of type 'category' but the MVT tile contained a feature property of type '${propertyValueType}': '${propertyValue}'`);
        }
