...
export default class MVTCategoryCodec extends CategoryCodec {
    sourceToInternal (propertyValue) {
        if (typeof propertyValue !== 'category') {
            ...
            throw new CartoRuntimeError(`${crt.MVT} MVT decoding error. Metadata property is of type 'category' but the MVT tile contained a feature property of type '${typeof propertyValue}': '${propertyValue}'`);
        }
