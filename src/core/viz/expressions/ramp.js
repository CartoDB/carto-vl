...
export default class Ramp extends Expression {
    ...
    *
    * @param {carto.viz.expressions.expression} input - The input expression to give a color
    * @param {carto.viz.expressions.palettes} palette - The color palette that is going to be used
