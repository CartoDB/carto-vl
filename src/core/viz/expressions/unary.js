 ...
 *
 * @param {carto.expressions.number|number} x - Number to compute the not value
 * @return {carto.expressions.number}
 *
 ...
 *
 * @param {carto.expressions.number|number} x - Number to compute the floor value
 * @return {carto.expressions.number}
 *
 ...
 *
 * @param {carto.expressions.number|number} x - Number to compute the ceil value
 * @return {carto.expressions.number}
 *
