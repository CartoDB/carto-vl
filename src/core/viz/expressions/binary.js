 ...
 *
 * @param {carto.viz.expressions.Expression | number} x numeric expression
 * @param {carto.viz.expressions.Expression | number} y numeric expression
 ...
 *
 * @param {carto.viz.expressions.Expression | number} numerator - Numerator of the division
 * @param {carto.viz.expressions.Expression | number} denominator - Denominator of the division
 * @return {carto.viz.expressions.Expression} numeric expression
 *
 ...
 *
 * @param {carto.viz.expressions.Expression | number} minuend - The minuend of the subtraction
 * @param {carto.viz.expressions.Expression | number} subtrahend - The subtrahend of the subtraction
 * @return {carto.viz.expressions.Expression} numeric expression
 *
 ...
 *
 * @param {carto.viz.expressions.Expression | number} base numeric expression
 * @param {carto.viz.expressions.Expression | number} exponent numeric expression
 * @return {carto.viz.expressions.Expression} numeric expression with base ^ exponent
 *
