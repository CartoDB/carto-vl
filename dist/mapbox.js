...
function styleWidth(e) {
    ...
    try {
        layer.style.getWidth().blendTo(__WEBPACK_IMPORTED_MODULE_0__src_index__["b" /* Style */].parseStyle(v), 1000);
    } catch (error) {
...
function styleColor(e) {
    ...
    try {
        layer.style.getColor().blendTo(__WEBPACK_IMPORTED_MODULE_0__src_index__["b" /* Style */].parseStyle(v), 1000);
    } catch (error) {
