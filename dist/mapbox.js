...
function styleWidth(e) {
    ...
    try {
        style.getWidth().blendTo(__WEBPACK_IMPORTED_MODULE_0__src_index__["c" /* Style */].parseStyleExpression(v, scheme), 1000);
...
function styleColor(e) {
    ...
    try {
        style.getColor().blendTo(__WEBPACK_IMPORTED_MODULE_0__src_index__["c" /* Style */].parseStyleExpression(v, scheme), 1000);
        document.getElementById("feedback").value = 'ok';
    } catch (error) {
...
function getData(aspect) {
    ...
    `;
        ...
        oReq.onload = function (oEvent) {
            ...
            tile.scheme = new __WEBPACK_IMPORTED_MODULE_0__src_index__["b" /* Scheme */](Object.keys(tile.properties), Object.keys(tile.properties).map(() => 'float'));
...
map.on('load', _ => {
    ...
    scheme = new __WEBPACK_IMPORTED_MODULE_0__src_index__["b" /* Scheme */](['temp', 'daten'], ['float', 'float']);
    style = new __WEBPACK_IMPORTED_MODULE_0__src_index__["c" /* Style */].Style(renderer, scheme);
